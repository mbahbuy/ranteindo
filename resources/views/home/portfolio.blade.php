      ...
      <main class="container" style="padding-top: 150px">
        <div class="row g-5 mb-4">
            <div class="col-md-12 ">
              @if ($portfolio->count())
                <div class="post">
                  <img src="{{ asset('assets') . '/' . $portfolio[0]->image }}" class="img-fluid first-item">
                  <div class="overlay-post">
                      <h5 class="text-white">{{ $portfolio[0]->title }}</h5>
                      <p class="text-white">{{ $portfolio[0]->excerpt }}</p>
                      <p class="text-white"><a href="{{ route('portfolio.show',$portfolio[0]->slug) }}">read more...</a></p>
                  </div>
                </div>
              @else                  
                <div class="post">
        ...
        <div class="row g-5">
          <div class="col-md-12">
            <div class="row">
              @if ($portfolio->count())
                  @foreach ($portfolio->skip(1) as $item)
