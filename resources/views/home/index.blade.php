...
<div class="main-banner" id="top">
  ...
  <div id="services" class="our-services section">
    <div class="services-right-dec">
      <img src="{{ asset('assets') }}/main/services-right-dec.png" alt="">
    </div>
    <div class="container">
      <div class="services-left-dec">
        <img src="{{ asset('assets') }}/main/services-left-dec.png" alt="">
      </div>
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="owl-carousel owl-services">
            <div class="item">
              ...
              <div class="icon"><img src="{{ asset('assets') }}/main/service-icon-01.png" alt=""></div>
              <p>Feel free to use this template for your business</p>
            </div>
            <div class="item">
              <h4>Develop The Best Strategy for Business</h4>
              <div class="icon"><img src="{{ asset('assets') }}/main/service-icon-02.png" alt=""></div>
              <p>Get to know more about the topic in details</p>
            </div>
            <div class="item">
              <h4>UI / UX Design and Development</h4>
              <div class="icon"><img src="{{ asset('assets') }}/main/service-icon-03.png" alt=""></div>
              <p>Get to know more about the topic in details</p>
            </div>
            <div class="item">
              <h4>Discover &amp; Explore our SEO Tips</h4>
              <div class="icon"><img src="{{ asset('assets') }}/main/service-icon-04.png" alt=""></div>
              <p>Feel free to use this template for your business</p>
            </div>
            <div class="item">
      ...
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="left-image">
            <img src="{{ asset('assets') }}/main/about-left-image.png" alt="Two Girls working together">
          </div>
        </div>
        <div class="col-lg-6">
          <div class="section-heading">
            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="fact-item">
                  <div class="count-area-content">
                    <div class="icon">
                      <img src="{{ asset('assets') }}/main/service-icon-01.png" alt="">
                    </div>
              ...
              <div class="col-lg-4">
                <div class="fact-item">
                  <div class="count-area-content">
                    <div class="icon">
                      <img src="{{ asset('assets') }}/main/service-icon-02.png" alt="">
                    </div>
              ...
              <div class="col-lg-4">
                <div class="fact-item">
                  <div class="count-area-content">
                    <div class="icon">
                      <img src="{{ asset('assets') }}/main/service-icon-03.png" alt="">
                    </div>
  ...
  <div id="portfolio" class="our-portfolio section">
    <div class="portfolio-left-dec">
      <img src="{{ asset('assets') }}/main/portfolio-left-dec.png" alt="">
    </div>
    <div class="container">
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="owl-carousel owl-portfolio">
            <div class="item">
              <div class="thumb">
                <img src="{{ asset('assets') }}/main/portfolio-01.jpg" alt="">
            ...
            <div class="item">
              <div class="thumb">
                <img src="{{ asset('assets') }}/main/portfolio-02.jpg" alt="">
                <div class="hover-effect">
                  <div class="inner-content">
            ...
            <div class="item">
              <div class="thumb">
                <img src="{{ asset('assets') }}/main/portfolio-03.jpg" alt="">
                <div class="hover-effect">
                  <div class="inner-content">
            ...
            <div class="item">
              <div class="thumb">
                <img src="{{ asset('assets') }}/main/portfolio-04.jpg" alt="">
                <div class="hover-effect">
                  <div class="inner-content">
  ...
  <div id="pricing" class="pricing-tables">
    <div class="tables-left-dec">
      <img src="{{ asset('assets') }}/main/tables-left-dec.png" alt="">
    </div>
    <div class="tables-right-dec">
      <img src="{{ asset('assets') }}/main/tables-right-dec.png" alt="">
    </div>
    <div class="container">
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
  ...
  <div id="video" class="our-videos section">
    <div class="videos-left-dec">
      <img src="{{ asset('assets') }}/main/videos-left-dec.png" alt="">
    </div>
    <div class="videos-right-dec">
      <img src="{{ asset('assets') }}/main/videos-right-dec.png" alt="">
    </div>
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  <div class="menu">
                    <div class="active">
                      <div class="thumb">
                        <img src="{{ asset('assets') }}/main/video-thumb-01.png" alt="">
                        <div class="inner-content">
                          <h4>Project One</h4>
                          <span>SEO &amp; Marketing</span>
                        </div>
                    ...
                    <div>
                      <div class="thumb">
                        <img src="{{ asset('assets') }}/main/video-thumb-02.png" alt="">
                        <div class="inner-content">
                    ...
                    <div>
                      <div class="thumb">
                        <img src="{{ asset('assets') }}/main/video-thumb-03.png" alt="Marketing">
                        <div class="inner-content">
                          <h4>Project Three</h4>
                          <span>Digital &amp; Marketing</span>
                        </div>
                    ...
                    <div>
                      <div class="thumb">
                        <img src="{{ asset('assets') }}/main/video-thumb-04.png" alt="SEO Work">
                        <div class="inner-content">
  ...
  <div id="contact" class="contact-us section">
    ...
    <div class="contact-dec">
      <img src="{{ asset('assets') }}/main/contact-dec.png" alt="">
    </div>
    <div class="contact-left-dec">
      <img src="{{ asset('assets') }}/main/contact-left-dec.png" alt="">
    </div>
  </div>

  <div class="footer-dec">
    <img src="{{ asset('assets') }}/main/footer-dec.png" alt="">
  </div>
