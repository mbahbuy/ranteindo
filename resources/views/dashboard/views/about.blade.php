            ...
            <div class="flex-auto p-4">
                <form method="POST" action="{{ route('views.about.relationship') }}" enctype="multipart/form-data">
                    ...
                    <div class="flex-auto px-1 pt-6">
                        ...
                        <div class="mb-6">
                            <div class="flex flex-col p-1.5 overflow-hidden border rounded-lg dark:border-gray-600 lg:flex-row dark:focus-within:border-blue-300 focus-within:ring focus-within:ring-opacity-40 focus-within:border-blue-400 focus-within:ring-blue-300">
                                <label for="projectberjalanvalue" class="px-4 py-3 w-full font-medium tracking-wider rounded-md font-bold uppercase align-middle transition-all bg-transparent border-0 rounded-lg">Jumlah Project Berjalan :</label>
                                <input  type="number" id="projectberjalanvalue" name="image" value="{{ $aboutvalue['image'] }}" class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow">
                            </div>
                            @error('image')
                                <span class="mt-2 text-sm text-red-600 dark:text-red-500" role="alert">
                                    <strong class="font-medium">{{ $message }}</strong>
