                ...
                <form method="POST" action="{{ route('views.project.title') }}" enctype="multipart/form-data">
                    ...
                    <div class="flex justify-center">
                        ...
                        <div class="flex flex-col max-w-full p-1.5 overflow-hidden border rounded-lg dark:border-gray-600 lg:flex-row dark:focus-within:border-blue-300 focus-within:ring focus-within:ring-opacity-40 focus-within:border-blue-400 focus-within:ring-blue-300">
                            <input class="px-6 py-2 text-gray-700 placeholder-gray-500 bg-white outline-none dark:bg-gray-800 dark:placeholder-gray-400 focus:placeholder-transparent dark:focus:placeholder-transparent" type="text" name="title" placeholder="Produk Title..." style="width: 500px">
    ...
    <div class="flex-none w-full max-w-full px-3 mt-6">
        <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
            <div class="p-4 pb-0 mb-0 bg-white rounded-t-2xl">
                ...
                <p class="leading-normal text-sm">Tambahkan atau hapus beberapa produk post</p>
            </div>
            <div class="flex-auto p-4">
                @if ($items->count())
